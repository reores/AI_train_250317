...
menu1.url = "?menu=1"
menu1.tips = ["2.1 fashion_mnist_softmax","2.2 CNN(컨볼루션 레이어 적용 모델)","2.3 가상화폐 가격분석 회귀(실무)", "2.4 mnist 데이터 컨볼루션 다중분류"] 
menu2 = new Menu("3. NLP_RNN 시계열 순환모델")
menu2.url = "?menu=2"
menu2.tips = ["3.1 네이버 리뷰 감성분석","3.2 네이버 쇼핑 감성분석","3.3 가상화폐 가격 예측"]
